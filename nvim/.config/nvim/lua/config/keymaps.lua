-- vim.keymap.set("i", "<Up>", "", { desc = "Disable Up in Insert" })
-- vim.keymap.set("i", "<Left>", "", { desc = "Disable Left in Insert" })
-- vim.keymap.set("i", "<Right>", "", { desc = "Disable Right in Insert" })
-- vim.keymap.set("i", "<Down>,", "", { desc = "Disable Down in Insert" })
--
-- vim.keymap.set("v", "<Up>", "", { desc = "Disable Up in Visual" })
-- vim.keymap.set("v", "<Left>", "", { desc = "Disable Left in Visual" })
